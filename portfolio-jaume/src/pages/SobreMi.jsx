    ...
    return (<>
        ...
        <section className="SobreMi">
            ...
            <div className='SobreMi-texto'>
                ...
                <p className="SobreMi-p">Fuera del teclado, me encanta la música (siempre me acompaña cuando programo) y pasar tiempo en la naturaleza. Me gusta hacer snorkel, jugar al voley, entrenar un poco y estar con mi perro. Creo que esas actividades me equilibran y me ayudan a volver al código con la cabeza fresca.</p>
